...
public class TeacherLeave extends JFrame implements ActionListener  {
    Choice cEmpId,cname, ctime;
    JDateChooser dcdate;
    JButton submit,b1, cancel;
    ...
    TeacherLeave() {
        ...
        cEmpId = new Choice();
        cEmpId.setBounds(150, 160, 200, 25);
        add(cEmpId);
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == submit) {
            ...
            String query = "insert into teacherleave values('"+rollno+"', '"+date+"', '"+duration+"','"+name+"')";
            ...
            ResultSet rs = null;
            try {
                rs = c.s.executeQuery("select * from facality where name = '"+cname.getSelectedItem()+"'");
                while (rs.next()) {
