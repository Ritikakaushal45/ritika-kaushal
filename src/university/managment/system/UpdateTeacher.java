...
public class UpdateTeacher extends JFrame implements ActionListener{
    ...
    UpdateTeacher() {
        ...
        try {
            conn c = new conn();
            ResultSet rs = c.s.executeQuery("select * from facality");
            while(rs.next()) {
        ...
        try {
            conn c = new conn();
            String query = "select * from facality where EMPID='"+cEmpId.getSelectedItem()+"'";
            ...
            while(rs.next()) {
                ...
                tfbranch.setText(rs.getString("DEPERTMENT"));
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == submit) {
            ...
            try {
                String query = "update facality set address='"+address+"', phone='"+phone+"', email='"+email+"', QUALIFICATION='"+course+"', depertment='"+branch+"' where EMPID='"+empId+"'";
                conn con = new conn();
